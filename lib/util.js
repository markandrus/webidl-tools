...
var defaultReplacements = new Map();
for (var match in _defaultReplacements) {
  defaultReplacements.set(new RegExp('^' + match + '$'),
    _defaultReplacements[match]);
}

exports.defaultReplacements = defaultReplacements;
