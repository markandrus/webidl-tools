...
/**
 * Construct a {@link CppContext}.
 * @class
 * @classdesc {@link CppContext} is used to render C++ templates.
 * @extends Context
 ...
 * @property {string} src
 */
function CppContext(options) {
  if (!(this instanceof CppContext)) {
    return new CppContext(options);
  }
 ...
 * @returns {string}
 */
CppContext.prototype.argumentDefault = function argumentDefault(member) {
 ...
 * @returns {string}
 */
CppContext.prototype.argumentName = function argumentName(member) {
 ...
 * @returns {string}
 */
CppContext.prototype.argumentType = function argumentType(member) {
  var ret = '';
 ...
 * @returns {string}
 */
CppContext.prototype.className = function className(node) {
  return node.name;
};
 ...
 * @returns {string}
 */
CppContext.prototype.enumName = function enumName(node) {
  return node.name;
};
 ...
 * @returns {string}
 */
CppContext.prototype.fromV8 = function fromV8(member) {
  return 'huh';
};
 ...
 * @returns {string}
 */
CppContext.prototype.headerDefine = function headerDefine(node) {
 ...
 * @returns {string}
 */
CppContext.prototype.headerName = function headerName(node) {
 ...
 * @returns {string}
 */
CppContext.prototype.initialize = function initialize(member) {
 ...
 * @returns {string}
 */
CppContext.prototype.privateMemberName = function privateMemberType(member) {
 ...
 * @returns {string}
 */
CppContext.prototype.privateMemberType = function privateMemberType(member) {
  if (member.default) {
 ...
 * @returns {string}
 */
CppContext.prototype.publicMemberName = function publicMemberName(member) {
  return member.name;
};
 ...
 * @returns {string}
 */
CppContext.prototype.publicMemberType = function publicMemberType(member) {
  return this.privateMemberType(member);
};

CppContext.prototype.toEnum = function toEnum(type, value) {
 ...
 * @returns {string}
 */
CppContext.prototype.toEnumName = function toEnumName(type, value) {
...
CppContext.prototype.toLiteral = function toLiteral(type, value) {
  try {
    return Context.prototype.toLiteral.call(this, type, value);
  } catch (error) {
    switch (type) {
      case 'bool':
...
CppContext.prototype.toStringLiteral = function toStringLiteral(value) {
 ...
 * @returns {string}
 */
CppContext.prototype.toV8 = function toV8(member) {
  return 'what';
};
 ...
 * @returns {string}
 */
CppContext.prototype.type = function type(idlType) {
